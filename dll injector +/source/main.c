...
#endif
uint8_t binary[] = {
//convert your dll into byte array and paste it in here
43434
...
#if SUCCESS_MESSAGE
    CHAR buf[100];
    sprintf_s(buf, sizeof(buf), "Aquarius by Pew successfuly injected into the csgo.exe have fun", PROCESS_NAME, (DWORD)executableImage);
